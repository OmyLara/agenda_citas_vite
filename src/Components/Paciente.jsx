const Paciente = ({paciente,setPaciente,eliminarPaciente}) =>{
    ...
    const {nombre,edad,email,fecha,time,notas,id} = paciente;
    ...
    return(
        <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl border-teal-600 border-solid border-2 shadow-teal-700/50">
